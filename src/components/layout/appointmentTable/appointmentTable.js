...
export function AppointmentTable() {
  ...
  const getAppointments = () => {
    fetch(
      `${urlString}appointments/` +
        `?sortMode=${orderDirection.toUpperCase()}&sortField=${valueToOrderBy}Field&page=${page}&search=${searchTerm}&id=${sessionStorage.getItem(
          "token"
