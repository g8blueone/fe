...
export function UserProfile() {
    ...
    const saveHandler = async (e) => {
        e.preventDefault();
        const response = await saveProfile(userId, first_name, last_name, email, date_of_birth, address, city, county, country)
    }
    ...
    const saveProfile = async (userId, first_name, last_name, email, date_of_birth, address, city, county, country) => {
        ...
        const status = new Promise((resolve) => {
            axios
                .put(`http://localhost:5000/patient/${userId}`, {
    ...
    return (
        <div className={`${styles["userContainer"]} d-flex flex-row justify-content-center`}>
            <div className={`d-flex flex-column justify-content-center ${styles['userCard']} align-self-center`}>
                    <div className={`align-self-center`}>
                        <img src={userSVG} alt="user" className={`h-100 p-3 ${styles["userSVG"]}`}></img>
                    </div>
            ...
            <div className={`${styles['userDetails']} d-flex flex-column justify-content-around p-4 align-self-center ps-5`}>
                <div className={`d-flex flex-row`}>
                    ...
                    <div className={`d-flex flex-column g-2 ms-3 me-3 ${styles["picker"]}`}>
